...
from apps.financial_management.tests.fixtures.financial_fixtures import (
    FinancialManagementModelFixtures,
)
...
class PatientManagementModelFixtures:
    def __init__(self) -> None:
        self.core_models_fixtures = CoreModelFixtures()
        self.finacial_model_fixtures = FinancialManagementModelFixtures()
    ...
    def patient_fixture(
        ...
        if plain is None:
            plain = self.finacial_model_fixtures.payment_plain_fixture()
    ...
    def prontuary_fixture(
        ...
        if type_of_service is None:
            type_of_service = self.core_models_fixtures.service_modality_fixture()
